...
```
zsh/
├── 00-env.zsh           # Early shared options loading
...
Modules are numbered **00-90 in increments of 10**, allowing insertion of new modules between existing ones.
...
### 00-env.zsh - Early Options

**Purpose**: Load shared dotfiles feature flags before plugin initialization.
